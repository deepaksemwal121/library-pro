        ...
        <aside className="border border-slate-200 bg-white p-4 text-sm rounded lg:sticky lg:top-0 lg:self-start">
          ...
          <div className="mt-4 space-y-2 border-t pt-3 text-xs">
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 bg-white border border-slate-300" style={{ borderRadius: "4px" }}></div>
              <span className="text-slate-600">Available</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 bg-gray-200 border border-gray-300" style={{ borderRadius: "4px" }}></div>
              <span className="text-slate-600">Occupied</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 bg-blue-500 border border-blue-700" style={{ borderRadius: "4px" }}></div>
